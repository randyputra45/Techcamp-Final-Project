                ...
                <div className="px-12 lg:px-16 xl:px-24 2xl:px-52">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-x-4 pt-32">
                        ...
                        <MemberCard
                            ...
                            role="Researcher"
                            desc="Mahasiswa yang sekarang sedang mengenyam pendidikan di Universitas Jember. Mempunyai passion dibidang IT khususnya Web Development dan UI/UX, dan memiliki hobi mendengarkan musik KPOP."
                            pic2="landing-konseling2.jpg"
                        />
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-x-4 pt-32">
                        ...
                        <MemberCard
                            ...
                            role="Researcher"
                            desc="Mahasiswa yang sekarang sedang mengenyam pendidikan di Politeknik Negeri Medan. Mempunyai passion dibidang IT khususnya Elektronika dan Web Design, dan memiliki hobi mendengarkan musik dan bersepeda dikala senggang."
                            pic2="landing-konseling2.jpg"
                        />
                        <img src="" alt="" className='hidden md:block w-2/6' />
                    </div>
